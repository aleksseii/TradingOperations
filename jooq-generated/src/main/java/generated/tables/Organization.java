...
public class Organization extends TableImpl<OrganizationRecord> {
    ...
    /**
     * The column <code>public.organization.org_id</code>.
     */
    public final TableField<OrganizationRecord, Integer> ORG_ID = createField(DSL.name("org_id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<OrganizationRecord, String> BANK_ACCOUNT = createField(DSL.name("bank_account"), SQLDataType.VARCHAR(50).nullable(false), this, "");
    ...
    public List<UniqueKey<OrganizationRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.ORGANIZATION_INN_KEY);
    }
